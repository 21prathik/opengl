...
void display()
{
    ...
    if (value == -1)
    {
        ...
        char name[]="PRATHIK.P";
        drawhead(-415,-550,0,name);
        char usn[]="4GH19CS037";
        drawhead(-150,-550,0,usn);
    ...
    if (value != -1)
    {
        ...
        if (value == 0)
        {
            ...
            drawhead(-490, 750, 0, nu);

            char bl[] = "BLUE REFERS NUCLEUS";
            drawhead(420, 750, 0, bl);
            char rd[] = "RED REFERS TO ORBIT PATH";
            drawhead(420, 650, 0, rd);
            char wh[] = "WHITE REFERS TO THE ELECTRONS";
            drawhead(420, 550, 0, wh);
        }
    }
    if (value == 1)
    {
